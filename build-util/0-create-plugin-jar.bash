...
#
#     ./tstool/NN/plugins/owf-tstool-reclamationhdb-plugin/1.2.3/
...
#mavenProjectFolder=${repoFolder}/owf-tstool-reclamationhdb-plugin
...
manifestFile="${repoFolder}/owf-tstool-reclamationhdb-plugin/src/main/resources/META-INF/MANIFEST.MF"
