...
#   ./tstool/NN/plugins/owf-tstool-reclamationhdb-plugin/${pluginVersion}
# - output is to the plugin 'dist' folder with filename like:
#     tstool-reclamationhdb-plugin-1.0.0-win-2206060102.zip
...
createPluginZipFile() {
  ...
  "${sevenzip}" a -tzip ${zipFile} "owf-tstool-reclamationhdb-plugin/${pluginVersion}"
  exitStatus=$?
...
devBinFolder="${repoFolder}/owf-tstool-reclamationhdb-plugin/target/classes"
...
mainPluginFolder="${pluginsFolder}/owf-tstool-reclamationhdb-plugin"

# Version installed folder for the plugin.
versionPluginFolder="${mainPluginFolder}/${pluginVersion}"

# Jar file for the plugin.
jarFile="${versionPluginFolder}/owf-tstool-reclamationhdb-plugin-${pluginVersion}.jar"

# Plugin dependency folder.
pluginDepFolder="${versionPluginFolder}/dep"

now=$(date +%Y%m%d%H%M)
zipFile="${distFolder}/tstool-reclamationhdb-plugin-${pluginVersion}-win-${now}.zip"
