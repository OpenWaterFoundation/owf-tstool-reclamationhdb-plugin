...
/**
This class is a table model for time series header information for Reclamation HDB time series.
...
public final int COL_START = 22; // This is actually the minimum start date/time.
public final int COL_END = 23; // This is actually the maximum start date/time>
